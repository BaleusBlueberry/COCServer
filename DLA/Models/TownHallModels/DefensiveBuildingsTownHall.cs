namespace DLA.Models.TownHallModels
{
    public class DefensiveBuildingsTownHall
    {
        ...
        public int SpellTower { get; set; } = 0;
        public int Monolith { get; set; } = 0;

        public int MultiArcherTower { get; set; } = 0;

        public int RicochetCannon { get; set; } = 0;

        public int Firespitter { get; set; } = 0;
    }
}
